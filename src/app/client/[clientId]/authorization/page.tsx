...
import type { AuthType, CycleAggregate, CycleEventKind, CycleStatus } from "@/domain";
import {
  SEEDS,
  SEED_NOW,
  activityLog,
 ...
 * clients: /client/jordan, /client/priya, /client/marcus. No drill-ins, no dev
 * strip yet.
 */
  ...
  return (
    <div className="flex-1 bg-zinc-50">
      <main className="mx-auto max-w-3xl px-8 py-12">
        ...
        <ProgressBar
          className="mt-8"
          phase={cycle.status.phase}
          isCycleSubmitted={isCycleSubmitted(agg)}
        />
        ...
        <section className="mt-10">
          ...
          <div className="mt-3 space-y-2">
            {packet.map((item) => (
              <PacketRow key={item.id} item={item} density="full" />
            ))}
          </div>
        </section>
